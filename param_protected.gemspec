...
Gem::Specification.new do |s|
  ...
  s.files = [
    "CHANGELOG",
     ...
     "test/app_root/app/controllers/defaults_controller.rb",
     "test/app_root/app/controllers/forgery_controller.rb",
     "test/app_root/app/controllers/protected_controller.rb",
     "test/app_root/app/controllers/roles_controller.rb",
     ...
     "test/forgery_controller_test.rb",
     "test/protected_controller_test.rb",
     "test/protector_test.rb",
     "test/roles_controller_test.rb",
     "test/test_helper.rb",
